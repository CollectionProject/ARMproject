 ...
 *  area. Adjust this variable, if you have additional enties.
 */
u16 comm_profile_last;
 ...
 */
u16 max_count_of_server_SDO;

u16 client_SDO_last;

u16 max_count_of_client_SDO;
...
typedef struct td_subindex
{
    ...
    u8                      size;       // The size (in Byte) of the variable
...
typedef struct td_indextable
{
    ...
    u8   bSubCount;   // the count of valid entries in for this subindex
...
typedef struct s_proc_info{
	u8 function_code;
	u8 name[20];
	u8 (*process_function)(u8, Message *);
} proceed_info;
